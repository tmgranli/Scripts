...
### Intune command for instlal "powershell.exe -executionpolicy ByPass -file .\install.ps1"
...
.\winget.exe install -e --id GIMP.GIMP --scope=machine --silent --accept-package-agreements --accept-source-agreements
