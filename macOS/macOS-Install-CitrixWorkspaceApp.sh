...
weburl="https://memtest.sarpsborg.com/test/CitrixWorkspaceApp.dmg"                                # What is the Azure Blob Storage URL?
    ...
    if [[ ${osvers_major} -ge 11 ]]; then
        ...
        if [[ -n "$processor" ]]; then
            ...
            if /usr/bin/pgrep oahd >/dev/null 2>&1; then
                ...
                /usr/sbin/softwareupdate âinstall-rosetta âagree-to-license
