...
then
	...
	${plistBuddy} -c "add :'Palo Alto Networks':'GlobalProtect':'PanSetup':'Portal' string 'cvpn.sarpdev.com'" ${GPplistFile}
...
then
	...
	echo "Preparing..."
	curl "https://memtest.sarpdev.com/Test/GlobalProtect.pkg" > "/tmp/GlobalProtect.pkg"
	echo "Installing..."	
